...
# Hasil Keluaran Cochrane-Orcutt dan Hildreth-Lu
...
Berdasarkan hasil analisis menggunakan dua metode (Cochrane-Orcutt dan Hildreth-Lu), terlihat bahwa kedua metode **belum mampu sepenuhnya menangani autokorelasi** pada model IPM ~ Tahun.  

Setelah dilakukan koreksi:  
- Nilai **Durbin-Watson meningkat**, menunjukkan autokorelasi menurun,  
- Nilai **SSE dan MSE berkurang**, menunjukkan model lebih baik dalam fitting.  

Namun, autokorelasi **tidak hilang sepenuhnya** dan SSE masih ada, sehingga **model belum valid**.  

Artinya, untuk memperoleh model yang lebih akurat, **diperlukan pendekatan lain**, misalnya dengan model time series yang lebih kompleks atau transformasi variabel tambahan.
